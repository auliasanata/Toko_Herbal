            ...
            <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active rounded">
                        <img src="{{ asset('assets/images/iklan.jpeg') }}" class="img-fluid w-100 bg-secondary rounded" alt="First slide" style="height: 500px;">
                        <a href="#" class="btn px-4 py-2 text-white rounded">Herbal Medicine</a>
                    </div>
                    <div class="carousel-item rounded">
                        <img src="{{ asset('assets/images/iklan3.jpg') }}" class="img-fluid w-100 rounded" alt="Second slide" style="height: 500px;">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                ...
                <div class="border border-primary rounded position-relative vesitable-item">
                    <div class="vesitable-img" style="justify-content: center; align-items: center;">
